...
import com.el.jdbc.coutomTypeHandler.BooleanTypeHandler;
import com.el.jdbc.coutomTypeHandler.PurifyStringTypeHandler;
import com.el.jdbc.dialect.MysqlDialect;
...
@MapperScan({"com.el.demo.mapper","com.el.security.mapper"})
public class CustomJdbcConfig {
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.el.excute.*.mapper");
